...
int GridGraph::countEdges() const {
  ...
  /*while (itr != adjacencyMap.end())
  {
	  numEdges=+ itr->second.size();
	  itr++;
  }*/
  for ( auto i : adjacencyMap)
  {
	  numEdges = numEdges + i.second.size();
  }
  // =======================================================================
  // TODO: Your code here!
  // =======================================================================
...
void GridGraph::removePoint(const IntPair& p1) {
  ...
  for (auto i : originalNeighbors)
  {
	  adjacencyMap.at(i).erase(p1);
	  //adjacencyMap.erase(i);
  }
